...
const questions = [
    ...
    {
        question: "Which famous painter is known for his works like 'Starry Night'?",
        answers: [
    ...
    {
        question: "If you drop a white piece of paper into a puddle of water, what color will the paper be after soaking it up?",
        answers: [
    ...
    {
        question: "If a car is traveling at 60 miles per hour, how long will it take to travel 120 miles?",
        answers: [
    ...
    {
        question: "If you have a 12-hour clock and it's showing 3 PM, what will be the time after 5 hours?",
        answers: [
    ...
    {
        question: "If you are in a room with no windows or doors, how can you get out?",
        answers: [
    ...
    {
        question: "If you have a basket containing 10 apples and you take away 3, how many apples do you have left?",
        answers: [
    ...
    {
        question: "If you are running a race and you overtake the person in second place, what place are you in?",
        answers: [
    ...
    {
        question: "If you see lightning and hear thunder, which event happened first?",
        answers: [
    ...
    {
        question: "You have a project deadline tomorrow and you’re feeling sick. What should you do?",
        answers: [
            { text: "Go to work and complete the project regardless", correct: false },
            { text: "Contact your supervisor, explain the situation, and request an extension if needed", correct: true },
            { text: "Ignore the deadline and take a sick day", correct: false },
            { text: "Try to finish the project while taking medication at home", correct: false }
        ]
    },
    {
        question: "You find a wallet on the street with a lot of cash inside and no ID. What should you do?",
        answers: [
    ...
    {
        question: "You are offered a job with a higher salary but it requires relocating to a different city. What should you consider first?",
        answers: [
    ...
    {
        question: "You have to make a decision between two equally attractive job offers. What should be your approach?",
        answers: [
            { text: "Choose based on which offer has the better location", correct: false },
            { text: "Pick the one that aligns best with your long-term career goals", correct: true },
            { text: "Go with the job that offers the most immediate benefits", correct: false },
            { text: "Select the job with the higher starting salary", correct: false }
        ]
    },
    {
        question: "You are at a social event and someone makes an inappropriate comment. What should you do?",
        answers: [
            { text: "Ignore the comment and avoid confrontation", correct: false },
            { text: "Confront the person publicly", correct: false },
            { text: "Address the issue calmly and privately, if necessary", correct: true },
            { text: "Leave the event immediately", correct: false }
        ]
    },
    {
        question: "You are managing a team and one of your team members is consistently underperforming. What should be your first step?",
        answers: [
            { text: "Ignore the problem and hope it resolves itself", correct: false },
            { text: "Speak to the team member privately to understand the issue", correct: true },
            { text: "Reprimand the team member in front of the whole team", correct: false },
            { text: "Immediately demote or replace the team member", correct: false }
        ]
    },
    {
        question: "You are planning a big event and one of your key suppliers fails to deliver on time. What should you do?",
        answers: [
            { text: "Panic and cancel the event", correct: false },
            { text: "Find an alternative supplier quickly and communicate with all parties involved", correct: true },
            { text: "Ignore the issue and hope the problem resolves itself", correct: false },
            { text: "Blame the supplier publicly", correct: false }
        ]
    },
    {
        question: "You receive conflicting advice from two trusted advisors on an important decision. What should be your approach?",
        answers: [
            { text: "Follow the advice of the one you like better", correct: false },
            { text: "Consider the advice carefully and weigh the pros and cons of each perspective", correct: true },
            { text: "Choose randomly between the two pieces of advice", correct: false },
            { text: "Seek advice from a third person before making a decision", correct: false }
        ]
    },
    {
        question: "You have a tight deadline and a crucial task is incomplete due to a mistake you made. What should you do?",
        answers: [
            { text: "Try to fix the mistake as quickly as possible and inform your team", correct: true },
    ...
    {
        question: "You are given the choice to spend an extra hour working on a project or an extra hour relaxing. What should you consider?",
        answers: [
            { text: "How much progress you can make on the project versus the need for relaxation", correct: true },
            ...
            { text: "It doesn’t matter; both options are equally important", correct: false }
        ]
    },
    {
        question: "You have two equally important tasks to complete, but you only have time for one. What should you do?",
        answers: [
